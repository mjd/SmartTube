...
public interface PlayerEngineEventListener {
     ...
     *
     * <p>{@code ExoPlaybackException.TYPE_OUT_OF_MEMORY} was removed upstream — out-of-memory now
     * arrives as {@code TYPE_UNEXPECTED}. Kept as a distinct app-level value (outside the range of
     * the real TYPE_* constants) so existing call sites keep compiling and the intent stays
     * readable; nothing produces it any more.
     */
    int ERROR_TYPE_OUT_OF_MEMORY = -1;
